...
export const EventDetails: Event[] = [
  ...
  },
  {
    ...
    {
      index: 0,
      name: 'Marie Curie becomes the first woman to win the Nobel Prize',
      date: 1903,
      dateEnding: 'AD',
      ...
      image: 'https://cdn.britannica.com/10/74610-050-19CB330C/Marie-Curie-Paris-laboratory.jpg',
    },
    {
      index: 0,
      name: 'Rosa Parks refuses to give up her bus seat',
      date: 1955,
      dateEnding: 'AD',
      details: 'Rosa Parks was an American activist in the civil rights movement best known for her pivotal role in the Montgomery bus boycott. The United States Congress has honored her as "the first lady of civil rights" and "the mother of the freedom movement".',
      link: 'https://www.history.com/topics/black-history/rosa-parks',
      image: 'https://cdn.britannica.com/90/3390-050-D62D761B/Rosa-Parks-bus-Montgomery-Alabama-1956.jpg',
    },
    {
      index: 0,
      name: 'Ada Lovelace writes first computer program',
      date: 1843,
      dateEnding: 'AD',
      details: 'Ada Lovelace was an English mathematician, an associate of Charles Babbage, for whose prototype of a digital computer she created a program. She has been called the first computer programmer. In 1833 Ada Lovelace met the mathematician Charles Babbage, who had designed a calculating machine called the Analytical Engine. Lovelace realized that the Analytical Engine could carry out an extensive sequence of mathematical operations. The example she wrote of one such sequence—how to calculate Bernoulli numbers—is regarded by computer historians as the first computer program.',
      link: 'https://www.britannica.com/biography/Ada-Lovelace',
      image: 'https://images.newscientist.com/wp-content/uploads/2021/05/11162637/ada-lovelace-htkrgb_web.jpg',
    },
    {
      index: 0,
      name: 'Women\'s suffrage (USA)',
      date: 1920,
      dateEnding: 'AD',
      details: 'Though the United States was founded under democratic principles, only a minority of its population – in the beginning only white landowning males over the age of 21 – could actually vote. But after the 19th Amendment of the Constitution was passed, women finally gain a voice and the right to cast their ballots, though the voting rights fight was far from over for many African American women, especially in the South.',
      link: 'https://www.archives.gov/milestone-documents/19th-amendment',
      image: 'https://assets.editorial.aetnd.com/uploads/2009/10/women-suffrage-gettyimages-514892136.jpg',
    },
    {
      index: 0,
      name: 'U.S. starts numbered highway system',
      date: 1926,
      dateEnding: 'AD',
      details: 'In a precursor to the modern interstate highway system, the federal government introduces a national highway numbering system in an effort to standardize roadways, especially local roads and trails with names unfamiliar to outsiders. The U.S. Numbered Highway System makes it easier for the growing number of car owners to figure out how to get from one city or town to the next and opens the way for the great American road-trip tradition.',
      link: 'https://www.fhwa.dot.gov/infrastructure/numbers.cfm',
      image: 'https://www.worldbook.com/images/pc373513_article.jpg',
    },
    {
      index: 0,
      name: 'Lindbergh flies across the Atlantic Ocean',
      date: 1927,
      dateEnding: 'AD',
      details: 'On May 21, 1927, Charles A. Lindbergh completed the first solo, nonstop transatlantic flight in history, flying his Spirit of St. Louis from Long Island, New York, to Paris, France.',
      link: 'https://pioneersofflight.si.edu/content/first-solo-nonstop-transatlantic-flight',
      image: 'https://cdn.britannica.com/35/196735-050-43739020/Charles-Lindbergh-San-Diego-Spirit-of-St-1927.jpg',
    },
];
